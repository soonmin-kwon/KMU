...
void init_buffer_objects()
{
  // TODO: Fill this function to initiazlize buffer objects
    ...
    for (int i = 0; i < scene->mNumMeshes; i++) {      
        ...
        GLfloat nom[mesh->mNumVertices * 3];
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(nom), nom, GL_STATIC_DRAW);
    }
}
...
void key_callback(GLFWwindow * window, int key, int scancode, int action, int mods)
{
  ...
  if(key == GLFW_KEY_D && action == GLFW_PRESS){
    light_position_wc[0] = 0.0f;
    light_position_wc[1] = -8.0f;
    light_position_wc[2] = 1.0f;
  }
...
void render_object()
{
  ...
  glUniform3f(loc_u_light_ambient, light_ambient[0],light_ambient[1],light_ambient[2]);
